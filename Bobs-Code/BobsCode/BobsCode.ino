...
void OnDataRecv(const esp_now_recv_info_t * esp_now_info, const uint8_t *incomingData, int len) {
  if (len == 16) {
    ...
    Serial.println("[VULNERABLE] ALICE SAYS: " + String(msg));
  }
    ...
    Serial.println("[SECURE] ALICE SAYS: " + String(msg));
  }
}
...
void setup() {
  ...
  Serial.println("[SYSTEM] Bob's Hardware Bridge Online. Awaiting USB commands...");
}
